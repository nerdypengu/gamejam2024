/*!/*:
@target MZ
@plugindesc CharacterCollisionEx v1.0.3
@author unagi ootoro
@help
...
(() => {
    ...
    if (typeof DotMoveSystem !== "undefined") {
        ...
        const _Game_Player_DotMoveMixin = class extends Game_Player {
            checkCollisionTargetEvent(x, y, d, event) {
                ...
                return _Game_Player_DotMoveMixin._checkCollisionTargetEvent.call(this, x, y, d, event);
            }
        };
        let Game_Player_DotMoveMixin = _Game_Player_DotMoveMixin;
        Game_Player_DotMoveMixin._checkCollisionTargetEvent = Game_Player.prototype.checkCollisionTargetEvent;
    ...
    if (typeof DotMoveSystem !== "undefined") {
        ...
        const _Game_Follower_DotMoveMixin = class extends Game_Follower {
            checkCollisionTargetEvent(x, y, d, event) {
                if (this.isThroughEvent())
                    return false;
                for (const tag of event.eventTags()) {
                ...
                return _Game_Follower_DotMoveMixin._checkCollisionTargetEvent.call(this, x, y, d, event);
            }
        };
        let Game_Follower_DotMoveMixin = _Game_Follower_DotMoveMixin;
        Game_Follower_DotMoveMixin._checkCollisionTargetEvent = Game_Follower.prototype.checkCollisionTargetEvent;
